...
public class BuildVars {
    ...
    // логи выключены даже в debug-сборке: форк личный, файлы логов с содержимым сессии не нужны
    ...
    // значения приходят из local.properties через BuildConfig; апстримовые публичные
    // креды оставлены запасным вариантом, но на форке логин с ними не проходит
    public static int APP_ID = BuildConfig.FORK_APP_ID != 0 ? BuildConfig.FORK_APP_ID : 4;
    public static String APP_HASH = !BuildConfig.FORK_APP_HASH.isEmpty() ? BuildConfig.FORK_APP_HASH : "014b35b6184100b085b0d0572f9b5103";
